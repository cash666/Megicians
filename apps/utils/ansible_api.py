...
class MyRunner(object):  
    ...
    def __initializeData(self):  
        ...
        self.options = Options(connection='smart', module_path='/devops/lib/python2.7/site-packages/ansible/modules', forks=10, timeout=10,  
    ...
    def run_playbook(self, role_name,tomcatname=None,tagname=None,host_list=None):  
	    ...
	    BASE_DIR="/etc/ansible"
            filenames = [BASE_DIR + '/roles/deploy_sim.yml'] 
